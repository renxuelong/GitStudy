...
**git flow feature finish some_awesome_feature** 该命令回把 feature/some_awesome_feature 合并到 develop 分支，并不会自动merge到master分支，然后自动删除feature分支，必须将改变commit后才可以使用该命令
